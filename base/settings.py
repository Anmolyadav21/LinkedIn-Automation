"""
Django settings for hiireach project.
...
SECRET_KEY = 'django-insecure-e430($o9p%bx#wc#)s)-io!p35wivb7^37r8rx(99wtol0zl@6'
...
MIDDLEWARE = [
    ...
    'django.middleware.csrf.CsrfViewMiddleware',  # <-- This middleware must be present
    'django.contrib.auth.middleware.AuthenticationMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    # 'django.middleware.clickjacking.XContentOptionsMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',  # Correct
